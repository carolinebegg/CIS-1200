...
public class TwitterBotTest {
    ...
    @Test
    public void nullReaderTwitterBot() {
        assertThrows(IllegalArgumentException.class, () -> new TwitterBot(null, 1));
    }

    @Test
    public void invalidColumnTwitterBot() {
        String filePath = "files/empty.csv";
        BufferedReader br = FileLineIterator.fileToReader(filePath);
        assertThrows(IllegalArgumentException.class, () -> new TwitterBot(br, -1));
    }

    @Test
    public void generateTweetNegativeNumWords() {
        String filePath = "files/empty.csv";
        BufferedReader br = FileLineIterator.fileToReader(filePath);
        TwitterBot t = new TwitterBot(br, 0);
        assertThrows(IllegalArgumentException.class, () -> t.generateTweet(-1));
    }

    @Test
    public void generateTweetZeroWords() {
        String filePath = "files/empty.csv";
        BufferedReader br = FileLineIterator.fileToReader(filePath);
        TwitterBot t = new TwitterBot(br, 0);
        assertEquals("", t.generateTweet(0));
    }

    @Test
    public void generateTweetOneWord() {
        List<String> desiredTweet = new ArrayList<>(
                Arrays.asList(
                        "hello", "."
                )
        ...
        TwitterBot t = new TwitterBot(br, 1);
        t.fixDistribution(desiredTweet);
        assertEquals("hello.", t.generateTweet(1));
    }

    @Test
    public void simpleTwitterBotMidTest() {
        List<String> desiredTweet = new ArrayList<>(
                Arrays.asList(
                        "hello", "world", "!", "my", "name", "is", "caroline", ".", "is", "cis",
                        "fun", "?"
                )
        );
        String words = "0, my name is caroline.\n"
                + "1, hello world!\n"
                + "2, is cis fun?";
        StringReader sr = new StringReader(words);
        BufferedReader br = new BufferedReader(sr);
        ...
        String expected = "hello world! my name is caroline. is cis fun?";
        String actual = t.generateTweet(9);
        assertEquals(expected, actual);
    }

    @Test
    public void testIsPunctuatedThreeWords() {
        List<String> desiredTweet = new ArrayList<>(
                Arrays.asList(
                        "hello", "cis1200", "world", "!"
                )
        ...
        String str = t.generateTweet(3);
        assertTrue(TwitterBot.isPunctuated(str));
    }

    @Test
    public void testIsPunctuatedOneWord() {
        List<String> desiredTweet = new ArrayList<>(
                Arrays.asList(
                        "hello", "!"
                )
        ...
        String str = t.generateTweet(1);
        assertTrue(TwitterBot.isPunctuated(str));
    }

    @Test
    public void testIsPunctuatedTrueEmpty() {
        String s = "";
        assertFalse(TwitterBot.isPunctuated(s));
    }

    @Test
    public void testWriteStringsToFileTrue() {
        String filePath = "files/write_strings_to_file_test_true.csv";
        boolean append = true;
        ...
        strings.add("my name is caroline");
        strings.add("i am a freshman");
        strings.add("cis is so fun");

        t.writeStringsToFile(strings, filePath, append);
        t.writeStringsToFile(strings, filePath, append);
    }

    @Test
    public void testWriteStringsToFileFalse() {
        String filePath = "files/write_strings_to_file_test_false.csv";
